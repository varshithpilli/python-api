...
@router.put("/{id}")
def update_post(id: int, response: Response, post: schemas.PostUpdate, db: Session = Depends(get_db), response_model=schemas.Post, user: int = Depends(oauth2.get_current_user)):
